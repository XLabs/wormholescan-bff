...
export type MatchingEngine = {
  ...
  instructions: [
    {
      ...
      accounts: [
        ...
        {
          name: "history";
          docs: ["because we will be writing to this account without using Anchor's [AccountsExit]."];
          writable: true;
        },
        {
          name: "auction";
    ...
    },
    {
      ...
      discriminator: [44, 104, 207, 178, 224, 7, 28, 219];
      accounts: [
        {
          name: "preparedBy";
          docs: [
      ...
      accounts: [
        ...
        },
        {
          ...
          accounts: [
            {
              name: "mint";
              docs: ["Circle-supported mint.", "", "Token Messenger Minter program's local token account."];
              writable: true;
            },
            {
            ...
            {
              name: "localToken";
              docs: ["Local token account, which this program uses to validate the `mint` used to burn.", ""];
              writable: true;
            },
            {
        ...
        },
        {
          ...
          accounts: [
            {
              name: "clock";
              docs: ["Wormhole Core Bridge needs the clock sysvar based on its legacy implementation.", ""];
            },
            {
              name: "rent";
              docs: ["Wormhole Core Bridge needs the rent sysvar based on its legacy implementation.", ""];
            },
          ];
        },
      ];
    ...
    },
    {
      ...
      discriminator: [206, 255, 241, 68, 224, 129, 210, 187];
      accounts: [
        {
    ...
    },
    {
      ...
      discriminator: [61, 148, 140, 87, 186, 87, 212, 239];
      accounts: [
        {
          name: "reserveSequence";
          accounts: [
  ...
  accounts: [
    ...
    },
    {
      ...
      discriminator: [70, 193, 18, 127, 227, 183, 46, 177];
    },
    {
      name: "preparedOrderResponse";
    ...
    },
    {
      ...
      discriminator: [77, 151, 219, 66, 126, 238, 151, 179];
    },
    {
      name: "routerEndpoint";
  ...
  events: [
    ...
    },
    {
      ...
      discriminator: [192, 96, 201, 180, 102, 112, 34, 102];
    },
    {
      name: "fastFillSequenceReserved";
      discriminator: [6, 154, 159, 87, 13, 183, 211, 152];
    },
    {
      name: "localFastOrderFilled";
      discriminator: [131, 247, 217, 194, 154, 179, 238, 193];
    },
    {
      name: "orderExecuted";
      ...
      type: {
        ...
        fields: [
          ...
          },
          {
            ...
            docs: ["Length of the redeemer message, which may impact the expense to execute the auction."];
            type: "u32";
          },
          {
    ...
    },
    {
      ...
      type: {
        ...
        fields: [
          ...
          {
            name: "bestOfferToken";
            docs: ["If there was an active auction, this pubkey is the best offer token that was paid back."];
            type: {
              option: "pubkey";
            };
          },
          ...
          {
            name: "withExecute";
            docs: ["This value will only be some if there was no active auction."];
            type: {
              option: {
                defined: {
                  name: "messageProtocol";
